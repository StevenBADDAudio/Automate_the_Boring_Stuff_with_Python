#You are creating a fantasy video game. The data structure to 
# model the player’s inventory will be a dictionary where the 
# keys are string values describing the item in the inventory 
# and the value is an integer value detailing how many of that 
# item the player has. For example, the dictionary value 
